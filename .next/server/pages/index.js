...
async function getStaticProps() {
  ...
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://femi:chemgenie1216@cluster0.07tx3.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
